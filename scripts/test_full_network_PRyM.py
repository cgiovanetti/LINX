...
abundance_model_full_PRIMAT_2018 = AbundanceModel(
    NuclearRates(nuclear_net='full_PRIMAT_2018')
)


res_T_18 = abundance_model_key_PRIMAT_2018(
    rho_g_vec, 
    rho_nu_vec, 
    rho_NP_vec,
    P_NP_vec,
...
res_final = abundance_model_full_PRIMAT_2018(
    rho_g_vec, 
    rho_nu_vec, 
    rho_NP_vec,
    P_NP_vec,
...
Neff_ref = 3.04438852
Y_p_ref = 0.24714545
D_over_H_e5_ref = 2.43970066 
He3_over_H_e5_ref = 1.03869063
Li7_over_H_e10_ref = 5.49247453
...
print('\n')
print('Percent Difference (LINX - PRyM) / PRyM: ')
